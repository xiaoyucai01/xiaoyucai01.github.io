...
loader.load('metal003.png', function(texture){
	...
	const materials = [
	    new THREE.MeshLambertMaterial({map: loader.load('01.jpg'), shading: THREE.FlatShading}),
	    new THREE.MeshLambertMaterial({map: loader.load('02.jpg'), shading: THREE.FlatShading}),
	    new THREE.MeshLambertMaterial({map: loader.load('03.jpg'), shading: THREE.FlatShading}),
	    new THREE.MeshLambertMaterial({map: loader.load('01.jpg'), shading: THREE.FlatShading}),
	    new THREE.MeshLambertMaterial({map: loader.load('02.jpg'), shading: THREE.FlatShading}),
	    new THREE.MeshLambertMaterial({map: loader.load('03.jpg'), shading: THREE.FlatShading}),
  	];
